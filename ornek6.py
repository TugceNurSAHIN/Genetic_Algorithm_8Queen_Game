...
# Form implementation generated from reading ui file 'ornek6.ui'
#
...
class Ui_MainWindow6(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "6x6 Sample"))
        ...
        if chrom_out[0]=="S":
            ...
            for i in range(6):
                self.button[6-dizin[i]][i].setText(_translate("MainWindow", "Q"))
                font = QtGui.QFont()
                font.setFamily("Uroob")
                font.setPointSize(25)
                font.setBold(True)
                font.setWeight(65)
                self.button[6-dizin[i]][i].setFont(font)
                self.button[6-dizin[i]][i].setStyleSheet("background-color: green")
