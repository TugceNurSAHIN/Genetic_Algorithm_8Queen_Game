...
# Form implementation generated from reading ui file 'ornek5.ui'
#
...
class Ui_MainWindow5(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "5x5 Sample"))
        ...
        if chrom_out[0]=="S":
            ...
            for i in range(5):
                self.button[5-dizin[i]][i].setText(_translate("MainWindow", "Q"))
                font = QtGui.QFont()
                font.setFamily("Uroob")
                font.setPointSize(25)
                font.setBold(True)
                font.setWeight(65)
                self.button[5-dizin[i]][i].setFont(font)
                self.button[5-dizin[i]][i].setStyleSheet("background-color: green")
