...
# Form implementation generated from reading ui file 'ornek7.ui'
#
...
class Ui_MainWindow7(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "7x7 Sample"))
        ...
        if chrom_out[0]=="S":
            ...
            for i in range(7):
                self.button[7-dizin[i]][i].setText(_translate("MainWindow", "Q"))
                font = QtGui.QFont()
                font.setFamily("Uroob")
                font.setPointSize(25)
                font.setBold(True)
                font.setWeight(65)
                self.button[7-dizin[i]][i].setFont(font)
                self.button[7-dizin[i]][i].setStyleSheet("background-color: green")
